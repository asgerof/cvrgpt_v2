...
async def test_redis_ping_success():
    ...
    with patch("cvrgpt_server.redis_client.redis_client.ping", new_callable=AsyncMock) as mock_ping:
        mock_ping.return_value = True

        # Import here to avoid MCP import issues
        from cvrgpt_server.redis_client import redis_client
...
def test_request_id_middleware_imports():
    ...
    from cvrgpt_server.observability import RequestIDMiddleware
